  ...
  if (user) {
    return (
      <div className="flex items-center gap-4">
        ...
        <Link href="/api/auth/logout" className="bg-red-600 text-white font-semibold py-2 px-4 rounded-lg shadow-md hover:bg-red-700 transition-colors duration-200">
          Abmelden
        </Link>
      </div>
    )
